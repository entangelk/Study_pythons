...
'''
SELECT UGB.TITLE,BOARD_ID,UGR.REPLY_ID,UGR.WRITER_ID,UGR.CONTENTS,DATE_FORMAT(UGR.CREATED_DATE,'%Y-%m-%d')
INNER JOIN USED_GOODS_BOARD UGB AND USED_GOODS_REPLY UGR

...
-- 코드를 입력하세요
SELECT PT.PRODUCT_CODE,	SUM(OS.SALES_AMOUNT*PT.PRICE) AS SALES
FROM PRODUCT PT
JOIN OFFLINE_SALE OS ON PT.PRODUCT_ID = OS.PRODUCT_ID
GROUP BY PT.PRODUCT_ID
ORDER BY SALES DESC, PT.PRODUCT_CODE ASC
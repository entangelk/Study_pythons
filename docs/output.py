...
str_first = '1. 컴퓨터 운영체제에 대한 선호도는 어떠신가요?'
print (str_first)
str_first = 'A. Windows B. macOS C. Linux D. Chrome OS E. 기타'
print (str_first)

str_first = '2. 주로 사용하는 프로그래밍 언어는 무엇인가요?' 
print(str_first)
str_first = 'A. Python B. Java C. JavaScript D. C++ E. 기타'
print(str_first)

print('****************************************************')

# 두개 이상의 변수 사용 출력 with 변수
question= '1. 컴퓨터 운영체제에 대한 선호도는 어떠신가요?'
print (question)
answer = 'A. Windows B. macOS C. Linux D. Chrome OS E. 기타'
print (answer)

question = '2. 주로 사용하는 프로그래밍 언어는 무엇인가요?' 
print(question)
answer = 'A. Python B. Java C. JavaScript D. C++ E. 기타'
print(answer)

question = '3. 개발자에게 인기 있는 프로그래밍 언어는 무엇인가요?'
print(question)
answer = 'A. Python B. Java C. JavaScript D. C++ E. 기타'
print(answer)
